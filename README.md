...
We live in an age where any online personality can receive feedback and input on the most mundane of
questions such as _which phone cover do you all prefer_ or _which is your favorite dish_ by all
their followers. Facebook likes offer instant feedback to billions of people. Yet, the arguably most
important decisions in our society are made through numerous indirect so called "representative
democracies".

Somehow, each of us needs to select one of several individuals or groups of individuals who we then
entrust with making decisions about anything from day-care funding to military operations to
insurance market regulation policies. If it turns out that the individual has committed false
advertising or decides to act differently from what he or she promised before, one can only wait for
the next election cycle.

Demonstrations, a form of political activism often cherished by democracies, often contain both
patient and hopeful individuals as well as more disillusioned and hot-headed characters. When
violence is observed, calls to _make your voice heard at the next ballot cast in X months_
\*\*\*\*are commonplace.

Looking back at recent history, another theme emerges: The discrepancy between those that take
actions and those that need to live with the consequences. _Fridays for Future_ is a movement that
can be quickly summarized as a desperate cry by the youth to point out our fears that the future is
going to be worse than the present, a sentiment that has not been around since the dark ages. A
bizarre picture of modern democracy is one where a 17 year old has no right to cast her vote on
climate topics despite having another 67 years of expected years on this planet while a 94 years old
citizen gets to shape the political spectrum despite a life expectancy of less than 5 years
[[1]](https://www-genesis.destatis.de/genesis/online?sequenz=tabelleErgebnis&selectionname=12621-0002&zeitscheiben=16&sachmerkmal=ALT577&sachschluessel=ALTVOLL000,ALTVOLL020,ALTVOLL040,ALTVOLL060,ALTVOLL065,ALTVOLL080#abreadcrumb).

### What if ...

- ... a system could be designed that permits anyone to vote on all things that matter without a
  need to replace the current democratic system?
- ... instead of needing to trust a stranger on their word with all the important decisions of
  society for at least 4 years, you could trust anyone with only the decisions that you want to hand
  off?
- ... instead of giving all decision powers to one person, they are instead split based on
  competencies?
- ... you could hand off your democratic voice on medical topics to your trusted doctor, taking all
  decisions on digital agenda yourself and letting your father in law represent you on matters of
  tax systems?
- ... the system took long-term impact into consideration and weighted the voices of those who have
  to suffer the consequences of a decision stronger than those who don't have to suffer the
  consequences?
- ... decisions were clearly structured and recorded in a publicly available and debatable system
  online by anyone, politician or citizen, putting a bar in front of false claims and overblown
  hypothetical future effects

In the following document a number of approaches will be explained that outline a modern way to
reinvent political participation for anyone on a massive scale so that we do politics the way that a
21st century deserves. A truly democratic system that takes everyone's voice into consideration and
that values transparency truly, exposing all processes and decisions to everyone.

Inspired by successes from Open Source Software developments, Behavioral Psychology and taking many
of our inherent cognitive biases into consideration, a set of tools and approaches will be explained
that should allow us to bring democracy to most democracies without any need to replace them, using
the vessel of representative democracy as a mechanism to introduce this new way of participating.

## Democracy invented after the inception of the internet

As a core principal of this idea, the question is not _how to change democracy to make it better_
but instead to ask the question _how would democracy look like if it was invented today?_ Only then
will we truly rid ourselves of ankers and old concepts and define a concept that scales like many of
our modern entertainment and social media platforms. The proposal therefore contains a set of
premises which can be considered already valid for some first world countries and easily achievable
by most others. The two premises are:

- Anyone has access to the internet for at least some period of time of their daily lives
  - Those who do not have access can be given access through a non-substantial amount through
    cellphones and mobile data networks or other systems
...
a poll and ask everyone what they should vote for. Then, the party votes for choice of the majority.
Even better, the party accurately represents the diverse opinions of its supporters. If 40% vote
"YES" and 60% "NO", the party does so as well in the parliament.
...
comfortable choosing themselves. This is in fact what we do today. We just don't have a choice. We
choose others to choose for us.
