...
- You want to see the world become democratic using 21st century solutions to 21st century problems
...
heard.
- **Resources**: submit pull requests to add links to related content.
...
changes to this project for now.
